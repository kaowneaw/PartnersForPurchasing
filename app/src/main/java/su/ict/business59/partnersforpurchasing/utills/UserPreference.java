...
public class UserPreference {
    ...
    public UserPreference(Context context, String userid, String username, String email, String img) {
        this(context);
        registerUserPreference(userid, username, email, img);
    }

    public void registerUserPreference(String userid, String username, String email, String img) {
